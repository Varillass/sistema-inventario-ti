"""
Configuración alternativa para SQLite (más simple para desarrollo)
Copia este contenido a settings.py si tienes problemas con MySQL
"""
...
# Database - SQLite (más simple para desarrollo)
DATABASES = {
    'default': {
